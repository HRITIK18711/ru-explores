...
const Footer = () => { 
  return ( 
    <footer className="relative text-white" style={{ backgroundImage: "url('/Image/footer_02.jpeg')", backgroundSize: "cover", backgroundPosition: "center", }} > 
      {/* Overlay */} 
      ...
      <div className="relative bg-transparent"> 
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-12"> 
          ...
          <div> 
            ...
            <p className="text-gray-200 leading-relaxed"> Thank you for visiting our official Travel website. Stay connected with us on social media for the latest updates. </p> 
          </div> 
          {/* QUICK LINKS */} 
          <div> 
          ...
          <div> 
            <h2 className="text-xl font-semibold mb-4 text-yellow-400"> Book Trek Packages </h2> 
          ...
          <div> 
            ...
            <p className="flex items-center gap-3 mb-4 text-gray-200"> <FaEnvelope className="text-yellow-400" /> ruexplores02@gmail.com </p> 
            <h3 className="text-lg font-semibold mb-3">Follow Us</h3> 
            <div className="flex space-x-4"> 
              <a href="#" className="bg-black/60 hover:bg-yellow-500 transition p-3 rounded-full"> <FaFacebookF /> </a> 
              <a href="#" className="bg-black/60 hover:bg-yellow-500 transition p-3 rounded-full"> <FaInstagram /> </a> 
              <a href="#" className="bg-black/60 hover:bg-yellow-500 transition p-3 rounded-full"> <FaYoutube /> </a> 
            </div> 
          </div> 
        </div> 
        {/* BOTTOM */} 
